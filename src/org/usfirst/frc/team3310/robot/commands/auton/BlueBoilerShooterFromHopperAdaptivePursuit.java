 ...
 *
 */
public class BlueBoilerShooterFromHopperAdaptivePursuit extends CommandGroup {
    
    public BlueBoilerShooterFromHopperAdaptivePursuit() {
...
//        addSequential(new DriveRelativeTurnPID(7, MPSoftwareTurnType.LEFT_SIDE_ONLY));
     	addSequential(new DriveRelativeTurnMP(11.5, Drive.MP_AUTON_MAX_TURN_RATE_DEG_PER_SEC, MPSoftwareTurnType.LEFT_SIDE_ONLY ));
