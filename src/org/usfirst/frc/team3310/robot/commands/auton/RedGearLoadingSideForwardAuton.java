 ...
 *
 */
public class RedGearLoadingSideForwardAuton extends CommandGroup {
    
    public RedGearLoadingSideForwardAuton() {
        ...
        addSequential(new DriveStraightMP(1322, Drive.MP_AUTON_MAX_LO_GEAR_STRAIGHT_VELOCITY_INCHES_PER_SEC, true, true, 172));
    }
}
