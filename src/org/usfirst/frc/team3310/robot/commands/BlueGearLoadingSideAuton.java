 ...
 *
 */
public class BlueGearLoadingSideAuton extends CommandGroup {
    
    public BlueGearLoadingSideAuton() {
...
//    	addParallel(new IntakeSetPosition(IntakePosition.BALL_INTAKE));
       ...
       addSequential(new DriveStraightMP(20, Drive.MP_GEAR_DEPLOY_VELOCITY_INCHES_PER_SEC, true, true, 60));
