...
public class RobotMap {
	...
	public static final int MAGIC_CARPET_ROLLER_MOTOR_CAN_ID = 5;
	public static final int SHOOTER_LIFT_MOTOR_CAN_ID = 6;
	public static final int SHOOTER_MAIN_MOTOR_CAN_ID = 7;
	public static final int SHOOTER_FEED_MOTOR_CAN_ID = 8;
	public static final int BALL_INTAKE_ROLLER_MOTOR_CAN_ID = 12;
	public static final int BALL_INTAKE_LIFT_MOTOR_CAN_ID = 3;
	public static final int GEAR_INTAKE_LIFT_MOTOR_CAN_ID = 4;
