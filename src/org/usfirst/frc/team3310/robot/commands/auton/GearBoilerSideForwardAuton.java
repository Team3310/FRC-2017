 ...
 *
 */
public class GearBoilerSideForwardAuton extends CommandGroup {
    
    public GearBoilerSideForwardAuton() {
        ...
        addSequential(new DriveAbsoluteTurnMP(141, Drive.MP_AUTON_MAX_TURN_RATE_DEG_PER_SEC, MPSoftwareTurnType.TANK));
    	addSequential(new CameraTurnToBestTarget());
       	addSequential(new ShooterSetVoltageRampRate(Shooter.SHOOT_VOLTAGE_RAMP_RATE));
        addSequential(new DriveStraightMP(104, Drive.MP_AUTON_MAX_STRAIGHT_VELOCITY_INCHES_PER_SEC, true, true, 141.0));
