...
import org.usfirst.frc.team3310.robot.commands.GearIntakeRollerSetDeployAuton;
import org.usfirst.frc.team3310.robot.commands.GearIntakeSetInnerPosition;
...
//        addParallel(new GearIntakeRollerSetDeployAuton(1.0));
        addSequential(new GearIntakeSetInnerPosition(GearPositionState.DOWN));
        addSequential(new DriveStraightMP(-23, Drive.MP_AUTON_MAX_BOILER_STRAIGHT_VELOCITY_INCHES_PER_SEC, true, true, -30)); //greenville -23
        ...
        addSequential(new ShooterSetHopperShake(0, 10, 3));
    }
}
