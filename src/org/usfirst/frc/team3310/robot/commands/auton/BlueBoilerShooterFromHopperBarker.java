...
public class BlueBoilerShooterFromHopperBarker extends CommandGroup {
    ...
    public BlueBoilerShooterFromHopperBarker() {
        ...
        addSequential(new DriveAbsoluteTurnMP(21, Drive.MP_AUTON_MAX_BOILER_TURN_RATE_DEG_PER_SEC, MPSoftwareTurnType.LEFT_SIDE_ONLY)); //greenville 30
 //       addParallel(new GearIntakeRollerSetDeployAuton(1.0));
        addSequential(new GearIntakeSetOuterPosition(GearPositionState.DOWN));
        addSequential(new DriveStraightMP(-36, Drive.MP_AUTON_MAX_BOILER_STRAIGHT_VELOCITY_INCHES_PER_SEC, true, true, 21)); //greenville -23
